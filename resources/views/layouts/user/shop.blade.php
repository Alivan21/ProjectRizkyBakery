  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-md-12 mb-3">
        <form action="{{ route('produk.search') }}" method="GET" class="form-inline justify-content-center">
      ...
      @foreach ($produk as $produks)
        <div class="col-md-4">
          <div class="card mb-5">
            <img src="{{ $produks->foto_produk }}" class="card-img-top mb-"
            ...
            <div class="card-body">
              ...
              <a href="{{ url('pesan') }}/{{ $produks->id }}" class="btn btn-primary"><i
